### Nice to meet you! 👋
My name is Lauren Lavelle and I just finished a full stack bootcamp at Michigan State University. Currently working at Central Transport as a pricing and audit analyst. My coding journey has been a great experience so far and excited to continue to grow my skillset. I have a passion for working on the back-end with both SQL and noSQL databases. I can get anything working functionally on the front-end and working to become better at design. My current projects include a blog that curate’s content for users with MERN stack and a professional portfolio using react. Interested in learning more about security in order to implement strategies to protect web applications, user data, and API's. <br>
